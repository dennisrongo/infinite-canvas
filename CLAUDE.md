...
This command **requires** the project directory as an argument via `C:\Users\denni\Documents\GitHub\infinite-canvas-web`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/app_spec.txt` and `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/initializer_prompt.md`

If `C:\Users\denni\Documents\GitHub\infinite-canvas-web` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/app_spec.txt`
...
**Output path:** `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/`!
>
> **Files created:**
> - `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/app_spec.txt`
> - `C:\Users\denni\Documents\GitHub\infinite-canvas-web/.autoforge/prompts/initializer_prompt.md`
>
